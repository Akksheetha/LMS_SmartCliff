...
When("user enters {string} in the search box", async function (this: CustomWorld, keyword: string) {
    await this.searchPage.searchCourse(keyword);
});

Then("the course {string} should be listed in the Course Structures table", async function (this: CustomWorld, expectedCourse: string) {
...
Then("the message {string} should be displayed", async function (this: CustomWorld, message: string) {
    await this.searchPage.assertMessage(message);
});

Then("{string} should be displayed in the page header", async function (this: CustomWorld, count: string) {
